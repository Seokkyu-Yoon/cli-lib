import { type AnsiEscape, AnsiEscapeFactory } from './ansi.escape'
...
export const UNICODES = Object.freeze({
  ...
  ANSI_ESCAPE: Object.freeze({
    CURSOR: Object.freeze({
      ...
      ups: (n: number) => unicodeByAnsiEscape(ansiEscapeFactory.cursor.ups(n)),
      downs: (n: number) =>
        unicodeByAnsiEscape(ansiEscapeFactory.cursor.downs(n)),
      rights: (n: number) =>
        unicodeByAnsiEscape(ansiEscapeFactory.cursor.rights(n)),
      lefts: (n: number) =>
        unicodeByAnsiEscape(ansiEscapeFactory.cursor.lefts(n)),
    }),
    TEXT: Object.freeze({
      ...
      FOREGROUND: Object.freeze({
        ...
        RGB: Object.freeze({
          decimal: (red: number, green: number, blue: number) =>
            unicodeByAnsiEscape(
              ansiEscapeFactory.text.fg.createByRgbDecimal(red, green, blue),
            ),
          hex: (hex: string) =>
            unicodeByAnsiEscape(ansiEscapeFactory.text.fg.createByRgbHex(hex)),
        }),
      }),
      BACKGROUND: Object.freeze({
        ...
        RGB: Object.freeze({
          ...
          hex: (hex: string) =>
            unicodeByAnsiEscape(ansiEscapeFactory.text.bg.createByRgbHex(hex)),
        }),
      }),
    }),
  }),
...
function unicodeByAnsiEscape(ansiEscape: AnsiEscape) {
