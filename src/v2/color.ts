...
export class RgbFactory {
  ...
  readonly red = this.createByDecimal(255, 0, 0)
  readonly green = this.createByDecimal(0, 255, 0)
  readonly blue = this.createByDecimal(0, 0, 255)
  readonly pink = this.createByDecimal(255, 0, 255)
  readonly cyan = this.createByDecimal(0, 255, 255)
  readonly yellow = this.createByDecimal(255, 255, 0)
  readonly white = this.createByDecimal(255, 255, 255)

  createByDecimal(red: number, green: number, blue: number) {
  ...
  createByHex(hex: string) {
    ...
    ).map((h) => this.colorFactory.createByHex(h))
    return new Rgb(colorRed, colorGreen, colorBlue)
  }
}
